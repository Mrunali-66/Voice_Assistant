...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        self.setStyleSheet("""
              /* Improved Vertical Scrollbar Styling */
                QScrollBar:vertical {
                    border: none;
                ...
                QScrollBar::handle:vertical {
                    background: rgba(100, 100, 100, 0.7);  /* Semi-transparent gray handle */
                    min-height: 30px;                      /* Larger minimum height for better grabbability */
                    border-radius: 5px;                    /* Rounded corners for the handle */
                    margin: 2px;                           /* Small margin for inset effect */
                }

                QScrollBar::handle:vertical:hover {
                    background: rgba(150, 150, 150, 0.8);  /* Lighter on hover for better feedback */
                }

                QScrollBar::handle:vertical:pressed {
                    background: rgba(180, 180, 180, 0.9);  /* Even lighter when pressed */
                }
                ...
                /* Make the scroll page area transparent */
                QScrollBar::add-page:vertical, 
                QScrollBar::sub-page:vertical {
                    background: none;
                }

                /* For a dark UI theme, add this horizontal scrollbar style to match */
...
class CustomTopBar(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Second section - Window control methods
    ...
    def showInitialScreen(self):
        ...
        # Fourth section - Main window class
